...
| --------- | ---------------------------- | ------------------------------ |
| App UI    | Fungio (Expo + React Native) | Minimal user-facing interface  |
| Routing   | Kaeluun Symbolic Layer       | GPS + BLE pattern optimization |
| Transport | BLE, GPS, WiFi Direct        | Message delivery mechanisms    |
| Storage   | AsyncStorage                 | Ephemeral logs & spores        |

<FungioEcosystemDiagram />
