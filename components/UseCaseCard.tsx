...
const UseCaseCard: React.FC<UseCaseCardProps> = ({ useCase }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 left-4 w-1 h-1 bg-glow-mint/30 rounded-full animate-spore-float shadow-[0_0_4px_rgba(140,255,218,0.4)] group-hover:bg-glow-mint/50 group-hover:shadow-[0_0_8px_rgba(140,255,218,0.6)] transition-all duration-500" style={{ animationDelay: '1.5s' }} />
      <div className="absolute top-1/2 right-6 w-1 h-1 bg-neural-violet/25 rounded-full animate-spore-float opacity-0 group-hover:opacity-100 transition-opacity duration-700" style={{ animationDelay: '2.5s' }} />
      
      <Icon className="h-14 w-14 mb-6 text-neural-violet/80 transition-all duration-700 group-hover:scale-110 group-hover:text-neural-violet group-hover:drop-shadow-[0_0_12px_rgba(122,92,255,0.6)] group-hover:rotate-3 animate-pulse-slow" />
      <h3 className="text-xl font-heading font-semibold mb-4 text-neural-violet/90 transition-all duration-500 group-hover:text-neural-violet group-hover:drop-shadow-[0_0_8px_rgba(122,92,255,0.4)]">{useCase.name}</h3>
      <p className="text-muted-white/70 group-hover:text-muted-white/85 transition-all duration-500 leading-relaxed">{useCase.description}</p>
